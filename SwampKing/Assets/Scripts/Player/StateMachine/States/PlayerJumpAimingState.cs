...
public class PlayerJumpAimingState : PlayerBaseState
{
    bool _hasLeftGround;
    ...
    public PlayerJumpAimingState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory)
