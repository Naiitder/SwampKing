...
public class PlayerFallAimingState : PlayerBaseState
{
    ...
    public PlayerFallAimingState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory)
