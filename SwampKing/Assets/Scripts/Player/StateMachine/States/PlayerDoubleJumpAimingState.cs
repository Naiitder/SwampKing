...
public class PlayerDoubleJumpAimingState : PlayerBaseState
{
    ...
    public PlayerDoubleJumpAimingState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory)
